...
class H5PEditorAjax extends Component {
     ...
     */
    public function __construct(\App\View\Components\H5PCore $H5PCore, H5peditor $H5PEditor, \H5peditorStorage $H5PEditorStorage) {
        $this->core = $H5PCore;
