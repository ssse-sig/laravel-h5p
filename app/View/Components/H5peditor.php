...
//use  app\View\Components\h5p-editor-php-library;
...
//        dd(H5PCore::libraryToString($newLibrary));
//        dd($newLibrary);
        ...
        switch ($field->type) {
            ...
            case 'library':
                if (isset($params->library) && isset($params->params)) {
                    ...
                    $semantics = $this->h5p->loadLibrarySemantics($library['name'], $library['major_version'], $library['minor_version']);
...
//        dd(get_object_vars($libraryData));
        return get_object_vars($libraryData);
    }
    ...
    public function getCachedLibsMap($cached_library) {
        ...
        $lib = array(
            ...
            'h5pMajorVersion' => intval($cached_library->major_version),
            'h5pMinorVersion' => intval($cached_library->minor_version),
